...
I'd add persistent storage (a database), richer recurrence rules, and a smarter conflict resolver that can swap or reschedule tasks instead of just warning.
